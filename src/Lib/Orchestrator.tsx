...
export class OrchestratorClient{
  ...
  async getGameAddress(){
    return this._publicClient?.readContract({...this.contract, functionName:'getGameAddress' })
  }

  async setGameAddress(address: Account, gameContractAddress: Account){
    return this._walletClient?.writeContract({...this.contract, account: address, chain:this._chain, functionName: 'setGameAddress', args:[gameContractAddress] })
  }
